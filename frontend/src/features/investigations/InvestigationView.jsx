// Part 4 -- Autonomous Investigation: investigate -> debate -> SAR draft,
// with the grounding and privacy guardrails shown per stage.
//
// Extracted verbatim from the original single-view App.jsx when the console
// grew to cover all five parts; the pipeline rendering is unchanged.
